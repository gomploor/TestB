...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND(Send_Expiration_Notification__c = true, Expiration_Date__c - TODAY() &gt;= 30, Notify_OLI_Expiration__c = true, ISPICKVAL( Waiting_Status__c, &apos;Live&apos; ))</formula>
    ...
    <rules>
        ...
        <formula>AND(Send_Expiration_Notification__c = true, (TODAY() - Expiration_Date__c &gt; 0),(TODAY() - Expiration_Date__c &lt;= 30), Notify_OLI_Expiration__c = true, ISPICKVAL( Waiting_Status__c, &apos;Live&apos; ))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>OLI_Expired_30_Days_Ago</name>
    ...
    <rules>
        ...
        <formula>AND(Send_Expiration_Notification__c = true, 
(Expiration_Date__c - TODAY() &lt; 7),(Expiration_Date__c - TODAY() &gt;= 0), Notify_OLI_Expiration__c = true, ISPICKVAL( Waiting_Status__c, &apos;Live&apos; ))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>OLI_Expires_Today</name>
    ...
    <rules>
        ...
        <formula>AND(Send_Expiration_Notification__c = true, 
(Expiration_Date__c - TODAY() &lt; 30),(Expiration_Date__c - TODAY() &gt;= 7), Notify_OLI_Expiration__c = true, 
